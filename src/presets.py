...
Each preset defines parameters and a system prompt for specialized use cases.
"""
...
class OllamaPreset:
    """A preset configuration for an Ollama model."""

    name: str
    """Display name of the preset (e.g., 'Balanced', 'Coder')."""

    config: str
    """PARAMETER lines for the Modelfile (multi-line string with PARAMETER directives)."""

    system: str
    """System prompt for the Modelfile (multi-line string)."""


# Preset configurations extracted from Bash source
...
def get_preset_by_name(name: str) -> OllamaPreset | None:
    ...
    Args:
        name: The name of the preset (e.g., 'Balanced', 'Coder').

    Returns:
        The OllamaPreset if found, None otherwise.
    """
...
def list_preset_names() -> list[str]:
    ...
    Returns:
        A list of preset names in order.
    """
