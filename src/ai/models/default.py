...
from .extensions.default_extension import DefaultExtension
...
class Default(BaseModelFamily):
    ...
    def normal(self, custom_name: str = ""):
        extension = DefaultExtension.get_normal(custom_name)
        return ModelConfig(
            mode="normal",
    ...
    def coder(self, custom_name: str = ""):
        extension = DefaultExtension.get_coder(custom_name)
        return ModelConfig(
            mode="coder",
            name="Coder",
            config=CODER_CONFIG,
    ...
    def coder_fast(self, custom_name: str = ""):
        extension = DefaultExtension.get_coder_fast(custom_name)
        return ModelConfig(
            mode="coder_fast",
            name="Coder Fast",
    ...
    def explained(self, custom_name: str = ""):
        extension = DefaultExtension.get_explained(custom_name)
        return ModelConfig(
            mode="explained",
            name="Explained",
